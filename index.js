...
$(window).on('load', function () {
  $(function () {
    ...
    $(function () {
      ...
      $('.home-link').on('click', function () {
        gsap.to('.go-ac-project', .5, { scale: .9 });
        gsap.to('.go-ac-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.go-ac-project', 0, { display: 'none', delay: .7 });
        gsap.to('.wcolor-project', .5, { scale: .9 });
        gsap.to('.wcolor-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.wcolor-project', 0, { display: 'none', delay: .7 });
        gsap.to('.marker-project', .5, { scale: .9 });
        gsap.to('.marker-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.marker-project', 0, { display: 'none', delay: .7 });
        gsap.to('.pencil-project', .5, { scale: .9 });
        gsap.to('.pencil-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.pencil-project', 0, { display: 'none', delay: .7 });
      ...
      $('.pencil-project-link').on('click', function () {
        gsap.to('#home', .5, { scale: .9 });
        gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('#home', 0, { display: 'none', delay: .7 });
        gsap.to('.pencil-project', 0, { display: 'block', delay: .7 })
        gsap.to('.pencil-project', .5, { scale: 1, delay: 1.1 })
        gsap.to('.project-name', .5, { opacity: 0, delay: 2.5 })
        gsap.to('#breaker', { display: 'block' })
        gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
      })
      $('.marker-project-link').on('click', function () {
        gsap.to('#home', .5, { scale: .9 });
        gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('#home', 0, { display: 'none', delay: .7 });
        gsap.to('.marker-project', 0, { display: 'block', delay: .7 })
        gsap.to('.marker-project', .5, { scale: 1, delay: 1.1 })
        gsap.to('.project-name', .5, { opacity: 0, delay: 2.5 })
        gsap.to('#breaker', { display: 'block' })
        gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
      })
      $('.wcolor-project-link').on('click', function () {
        gsap.to('#home', .5, { scale: .9 });
        gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('#home', 0, { display: 'none', delay: .7 });
        gsap.to('.wcolor-project', 0, { display: 'block', delay: .7 })
        gsap.to('.wcolor-project', .5, { scale: 1, delay: 1.1 })
        gsap.to('.project-name', .5, { opacity: 0, delay: 2.5 })
        gsap.to('#breaker', { display: 'block' })
        gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
      })
      $('.go-ac-project-link').on('click', function () {
        gsap.to('#home', .5, { scale: .9 });
        gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('#home', 0, { display: 'none', delay: .7 });
        gsap.to('.go-ac-project', 0, { display: 'block', delay: .7 })
        gsap.to('.go-ac-project', .5, { scale: 1, delay: 1.1 })
        gsap.to('.project-name', .5, { opacity: 0, delay: 2.5 })
        gsap.to('#breaker', { display: 'block' })
        gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
      })
      ...
      $('.pencil-close').on('click', function () {
        gsap.to('.pencil-project', .5, { scale: .9 });
        gsap.to('.pencil-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.pencil-project', 0, { display: 'none', delay: .7 });
        gsap.to('#home', 0, { display: 'block', delay: .7 })
      ...
      $('.wcolor-close').on('click', function () {
        gsap.to('.wcolor-project', .5, { scale: .9 });
        gsap.to('.wcolor-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.wcolor-project', 0, { display: 'none', delay: .7 });
        gsap.to('#home', 0, { display: 'block', delay: .7 })
